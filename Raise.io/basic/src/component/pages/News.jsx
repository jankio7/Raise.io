      ...
      <div className="collapse navbar-collapse" id="navbarNav">
        <ul className="navbar-nav ms-auto">
          <li className="nav-item">
            <a className="nav-link smoothscroll" href="index.html#section_1">
              Home
            </a>
          </li>
          <li className="nav-item">
            <a className="nav-link smoothscroll" href="index.html#section_2">
              About
            </a>
          </li>
          <li className="nav-item">
            <a className="nav-link smoothscroll" href="index.html#section_3">
              Causes
            </a>
          </li>
          <li className="nav-item">
            <a className="nav-link smoothscroll" href="index.html#section_4">
              Volunteer
            </a>
          </li>
          <li className="nav-item dropdown">
            ...
            >
              <li>
                <a className="dropdown-item active" href="news.html">
                  News Listing
                </a>
              </li>
              <li>
          ...
          <li className="nav-item">
            <a className="nav-link smoothscroll" href="index.html#section_6">
              Contact
            </a>
          </li>
